        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" method="post" action="{{ url('/admin/edit-shipping/'.$shippingDetails->id) }}" name="edit_shipping" id="edit_shipping" novalidate="novalidate">
                {{ csrf_field() }}
                ...
                <div class="control-group">
                    <label class="control-label" style="font-size: 13px; width:220px;">Shipping Charge(0-500g) &nbsp;</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label" style="font-size: 13px; width:220px;">Shipping Charge(501-1000g) &nbsp;</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label" style="font-size: 13px; width:220px;">Shipping Charge(1001-2000g) &nbsp;</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label" style="font-size: 13px; width:220px;">Shipping Charge(2001-5000g) &nbsp;</label>
                    <div class="controls">
