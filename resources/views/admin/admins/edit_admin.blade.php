...
<div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Admins / Sub-Admins</a> <a href="#" class="current">Edit Admin</a> </div>
      <h1>Admin / Sub Admins</h1>
        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" method="post" action="{{ url('/admin/edit-admin/'.$adminDetails->id) }}" name="editadmin" id="editadmin" novalidate="novalidate">
                {{ csrf_field() }}
                ...
                @if($adminDetails->type=="Sub Admin")
                    ...
                    <label class="control-label">Access</label>
                        <div class="controls">
                            ...
                            <input type="checkbox" name="categories_full_access" id="categories_full_access" value="1" style="margin-top: -3px;" @if($adminDetails->categories_full_access == "1") checked @endif>&nbsp;Categories View, Edit & Delete Only &nbsp;&nbsp;&nbsp;
