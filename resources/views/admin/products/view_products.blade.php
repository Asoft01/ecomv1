                      ...
                      <tr class="gradeX">
                          ...
                          <td>
                            @if(!empty($product->image))
                             ...
                             <img src="{{ asset('/images/backend_images/products/small/'.$product->image) }}" alt="" style="width: 70px">
                            @endif
                          </td>
                          ...
                          <td class="center"> 
                            ...
                            <a rel="{{ $product->id }}" rel1="delete-product" <?php /* href="{{url('/admin/delete-product/'.$product->id ) }}" */ ?> href="javascript:" class="btn btn-danger btn-mini deleteRecord" title="Delete Products">Delete</a></td>
